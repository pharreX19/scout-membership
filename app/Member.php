...
class Member extends Model
{
    ...
    public static $rules = [
        ...
        'id_number' => 'string|required|max:8|unique:members,id_number, NULL,id,deleted_at, NULL',
        'school_id' => 'required|numeric|exists:schools,id',
        'birth_date' => 'date|required',
        'address'=> 'nullable|string|nullable|max:30',
        'contact'=> 'numeric|nullable|digits:7',
        'email' => 'email|nullable|max:30|unique:members,email, NULL, id, deleted_at,NULL',
    ...
    public static $updateRules = [
        ...
        'id_number' => 'string|sometimes|max:8|unique:members,id_number, NULL,id,deleted_at, NULL',
